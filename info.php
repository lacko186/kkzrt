    ...
    --primary-color:linear-gradient(to right, #211717,#b30000);
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(to right, black, darkred, gray, white);
            color: #000;
            min-height: 100vh;
...
<section id="about" class="card" style="font-weight: bold; color: gray">
            <div>
              ...
              <br>
                <h2 style="text-align:center">Korábbi üzletszabályzatok:</h2><br>
                <div></div><li></i>Aktuális üzletszabályzat:Érvényes 2022. október 17-től</li></div>
